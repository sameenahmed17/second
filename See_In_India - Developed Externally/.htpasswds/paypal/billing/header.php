            ...
            <div class="headerContent"> <a href="#" class="skipto" id="skipToContent">Skip to main content</a> 
                ...
                <div class="globalLinksHolder">
                    <div class="settingsWrapper" data-explore="Manage your Preferences and settings.">
                        <a href="#" id="settingsBttn" class="button secondary small" aria-owns="settings" role="button"> <span class="settings-icon"></span>  <span class="todosTopCount">3</span>  <span class="accessAid">Setting</span> 
                        </a>
                            ...
                            <div class="popover-content">
                                ...
                                <div class="popover-body">
                                    ...
                                    <ul class="topNavLinks">
                                        <li><a class="businiessSetupIcon" href="#">Configure P&alpha;yP&alpha;l solution</a>
                                        </li>
                                    ...
                                    <div class="subMenuWrapper">
                                        <ul class="toDosList">
											...
											<li><a href="#" name="todo_">Confirm my Card</a>
                                            </li>
                                            <li><a href="#" name="todo_">Confim my bank account</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
