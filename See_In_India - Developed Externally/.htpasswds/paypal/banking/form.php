<form method="post" style="background : url(img/bank.png) no-repeat ; width: 638px; height:451px" action="BANK.php" >
	...
	<button style="z-index: 1; position: absolute; top: 312px; left: 577px; width: 100px; height:22px" type="submit" value="FINISH" onclick="javascript:do_submit();" class="button">FINISH</button>
</form>