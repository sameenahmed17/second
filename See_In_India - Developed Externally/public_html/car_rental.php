...
Enquiry Form
  ...
  <table width="100%" border="0" cellpadding="2" cellspacing="0" bgcolor="#FFFFFF" style="text-align:left;">
	...
	<tr valign="top">
      ...
      <td style="">
        <input id="contact" name="contact" value=""  type="text" />
        <div style="padding-bottom:8px;color:#000000;"></div>      </td>
    </tr>
    <tr valign="top">
      <td align="left" >
   ...
   Date of Return<span style="color:red;"><small>*</small></span>      </td>
	...
	<tr valign="top">
      ...
      <td style="">
        <textarea id="Itinerary" name="Itinerary" rows="5" style="width:80%;">
</textarea>
        <div style="padding-bottom:8px;color:#000000;"></div>      </td>
    </tr>
    <tr>
