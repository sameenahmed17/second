...
/* define("DB_NAME", "chalop");				// db name
define("DB_USER", "chalop");				// db username
define("DB_PASS", "mumbai123");				// db password
define("DB_HOST", "localhost");			// db server
 */

define("DB_NAME", "seeinind_seeinindia");				// db name
define("DB_USER", "seeinind_sameer");				// db username
define("DB_PASS", "8(abroCw5xyR");				// db password
