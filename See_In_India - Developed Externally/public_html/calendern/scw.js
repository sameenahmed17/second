...
//******************************************************************************
    ...
    var scwDateDisplayFormat = 'mm-dd-yyyy';//'yyyy-mm-dd';//     // e.g. 'MMM-DD-YYYY' for the US

    // Output date format

    var scwDateOutputFormat  = 'mm-dd-yyyy';//'yyyy-mm-dd';// e.g. 'MMM-DD-YYYY' for the US
