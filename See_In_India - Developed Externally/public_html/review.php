<?php 
	...
	if(isset($_POST['comments'])) { 
		$obj->comment($_POST, $_SESSION['username']);
	}
			...
			<div class="main-contents">
				<div class="container">
					<div class="row">
							...
							<h2 class="ft-heading text-upper">Give us Review</h2>
							<form action="" method="post" name="review-form">
								<fieldset>
									<ul class="formFields list-unstyled">
										<li class="row">
										
                                            <div class="col-md-6">
												<label>Comments <span class="required small">(Required)</span></label>
