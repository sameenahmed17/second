...
function changecaptcha()
{
	...
	if(captchacode != captchahidden)
	{
		...
		/* document.getElementById('readcaptcha').value="";
		  $.ajax({
		method:"GET",
		url: "captcha.php",
		success: function( result ) {
		//alert(result);
		$("#readcaptcha").val(result);
							...
							<form method="post" enctype="multipart/form-data" id="register-form" name="register-form" >
								<fieldset>
									<ul class="formFields list-unstyled">
										...
										<li class="row">
											<div class="col-md-6">
												<label>Upload Your Photo <span class="required small">(Required)</span></label>
