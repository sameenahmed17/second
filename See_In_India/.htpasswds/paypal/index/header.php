...
<a href="#" class="paypal-img-logo">&Rho;ay&Rho;al</a>
...
<a href="#" id="header-buy" rel="menuitem" aria-controls="submenu-buy" role="button" aria-expanded="false">Buy</a>
                                ...
                                <div class="menu-wrapper" id="submenu-buy" aria-labelledby="header-buy">
                                    <ul id="header-buy-menu" class="subnav list">
                                            ...
                                            <li>
<a href="#">&Rho;ay on eB&alpha;y</a>
</li>
                                        
                                            <li>
<a href="#">&Rho;ay on websites</a>
</li>
                                        
                                            <li>
<a href="#">&Rho;ay on the go</a>
</li>
                                        
                                            <li>
<a href="#	">&Rho;ay in stores</a>
</li>
...
<a href="#" id="header-send" rel="menuitem" class="desktop-only" aria-controls="submenu-send" role="button" aria-expanded="false">Send</a>
    ...
    <div class="step shown" id="send-money-step-1" data-step="step">
        <div>
            <strong class="headline medium">Send m&omicron;ney in a few clicks</strong>
    ...
    <div class="step" id="send-money-step-2" data-step="submit">
        <div class="button-choices">
            <div class="choice">
                ...
                <p id="choice-1">Free for both of you when sent domestically in USD, and funded with your &Rho;ay&Rho;al bal&alpha;nce or b&alpha;nk account.</p>
            ...
            <div class="choice">
                ...
                <p id="choice-2">Free for you. The seller pays a small fee to process the p&alpha;yment. You?re also covered by our <a href="/webapps/mpp/paypal-safety-and-security">Purchase Protection</a>.</p>
