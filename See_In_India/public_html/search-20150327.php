						...
						<div class="row">
							...
							<section class="col-sm-6">
								<ol class="breadcrumb">
									...
									<li><a href="#"><?php if(isset($_POST['where_to_go'])){echo $_POST['where_to_go'];}else{echo $_GET['city'];} ?></a></li>
								</ol>
							</section>
						</div>
					</div>
                        ...
                        <aside id="sidebar" class="col-md-3"><!-- Right Part -->
                           ...
                           <form action="search.php" method="post" name="search" onsubmit="return validate();">                       
                                <div class="top-fields">
                                    <div class="input-field col-md-12"><input type="text" placeholder="Where to go?"  name="where_to_go" value="<? if(isset($_POST['where_to_go']) && !empty($_POST['where_to_go'])){echo $_POST['where_to_go'];}else{echo $_GET['city'];}?>" /></div>
