<?php 
	...
	$sql_booking = mysql_query("select * from checkout where id='$_GET[id]'");
  ...
  ga('send', 'pageview');
	...
	<body>
		...
		<div id="wrapper">
            ...
            <div><label for="telephone"><strong>Cancellation Policy</strong> : <?php echo $cancellation_diff; ?>% Cancellation will be applicable to the booking in case of cancelation before departure</label></div>
        	<div><a href="booking-cancelled.php?id=<?php echo $booking['id'] ?>"><img src="images/proceed_cancel_btn.png" /></a></div>
