<?php
	...
	$where = $_REQUEST['search_header'];
	
	$query="select * from tours where city LIKE '%$where%' OR nameof_tour LIKE '%$where%' OR shortdescription LIKE '%$where%' OR longdescription LIKE '%$where%' AND from_date BETWEEN '$from_date' AND '$to_date' ";
...
$sql2 = "select * from tours where city LIKE '%$where%' OR nameof_tour LIKE '%$where%' OR shortdescription LIKE '%$where%' OR longdescription LIKE '%$where%' AND from_date BETWEEN '$from_date' AND '$to_date'";
