<?php 
	...
	$mybody.='<body><div class="main" style="float:left; background-color:#e6e6e7;">';
	
	$mybody.='<table width="70%" border="0" cellspacing="5" cellpadding="5" align="center">';
			
	
			  
			  $mybody.='<div style="width:80%; height:30%; padding:10px; background:#050104; margin:0 auto; border-radius:8px; border:2px dashed #FFF;
	font-family:Verdana, Geneva, sans-serif; font-size:10px; color:#FFF;">
                	<table width="100%" border="0" cellspacing="5" cellpadding="0">
                      <tr>
                        <td><img src="http://seeinindia.com/images/logo123.png" width="250" height="112" /></td>
                        <td><table width="50%" border="0" cellspacing="5" cellpadding="0" style="float:right;">
                              <tr>
                                <td style="float:right; color:#FFF; font-size:12px;"><img src="http://seeinindia.com/images/barcode.png" width="123" height="55" /></td>
                              </tr>
                              <tr>
                                <td style="color:#FFF; font-size:14px; float:right; padding-right:15px;">1412891523</td>
                              </tr>
                            </table>
                        </td>
                      </tr>
	...
	$mybody.='<tr>
			  <td>
			  <div class="first" style="width:80%; height:30%; padding:10px; background:#ffff01; margin:0 auto; border-radius:8px; border:2px dashed #000;
	...
	$mybody.='<tr>
     ...
     $mybody.='<tr>
	  ...
	  $mybody.='<tr>
		...
		<tr>
		<td><img src="http://seeinindia.com/images/logo123.png" width="123" height="55" /></td>
		</tr>
		<tr>
		<td>&nbsp;</td>
		</tr>
		<tr>
		<td><img src="http://seeinindia.com/images/barcode.png" width="123" height="55" /></td>
		</tr>
		<tr>
		<td>&nbsp;</td>
		</tr>';
		...
		<td>';
					  ...
					  $mybody.='<div class="second" style="width:80%;height:auto;padding:8px;background:#FFF;margin:0 auto;border-radius:8px;border:2px dashed #000;
      font-family:Verdana, Geneva, sans-serif;font-size:10px;color:#000;">
					...
					//$file_name = str_replace('', '-', strtolower( pathinfo(, PATHINFO_FILENAME)) );
					$file_name = str_replace(' ', '%20', $tours['picturegallery1']);
					
					$mybody.='</ul>
					<h4>Description</h4>
					<p><img src="http://seeinindia.com/admin/images/cityplace/'.$file_name.'" width="204" height="134" /><br><strong>Voucher Information : </strong>You can present either a paper or an electronic voucher for this activity. <br /><br />
					...
					$headers .= "From: ".$email." \r\n";
					//$headers .="To:" .$to. "\n";
					//$headers .= "BCC: BCC ".$to1.",".$to2."\n";
					
					$bodys .= "$mybody <br>";
					$subject = "See In India - Voucher for booking ID ".$booking_id;
					$body = $body . $bodys;
...
<body>
	...
	<div id="wrapper">
	    ...
	    <table width="70%" border="0" cellspacing="5" cellpadding="5" align="center">
			  ...
			  <tr>
			  <td>
			  <div style="width:80%; height:30%; padding:10px; background:#050104; margin:0 auto; border-radius:8px; border:2px dashed #FFF;
	font-family:Verdana, Geneva, sans-serif; font-size:10px; color:#FFF;">
                	<table width="100%" border="0" cellspacing="5" cellpadding="0">
                      <tr>
                        <td><img src="images/logo123.png" width="250" height="112" /></td>
                        <td><table width="50%" border="0" cellspacing="5" cellpadding="0" style="float:right;">
                              <tr>
                                <td style="float:right; color:#FFF; font-size:12px;"><img src="images/barcode.png" width="123" height="55" /></td>
                              </tr>
                              <tr>
                                <td style="color:#FFF; font-size:14px; float:right; padding-right:15px;">1412891523</td>
                              </tr>
                            ...
                            <td>
                                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      ...
                                      <tr>
                                        <td>Reference No</td>
                                        <td>:</td>
                                        <td> <?php echo $booking_id ?>-----<? echo $tours['picturegallery1']; ?></td>
                                      </tr>
                                      <tr>
                                        <td>Event Location</td>
                                        <td>:</td>
   	  ...
   	  <div class="second">
                        ...
                        <h4>Description</h4>
                <p><img src="admin/images/cityplace/<?php echo $tours['picturegallery1'] ?>" width="204" height="134" /><strong>Voucher Information : </strong>You can present either a paper or an electronic voucher for this activity. <br /><br />
