<?
	...
	if(isset($_GET['id'])) { 
		$search_tour = $obj->getMaintour($_GET['id']);
                        ...
                        <div class="col-md-9"><!-- Left Part -->
                        	...
                        	<div class="col-md-4">
                               <!--a href="tour-info.php?id=<?php //echo $home['id']?>&tour=<?php  //echo $lower_tour; ?>"--><a href="<?php echo $seo_url_tour_info; ?>"> <div class="ft-item">
                                    ...
                                    <div class="ft-foot">
                                        <h4 class="ft-title text-upper"><!--a href="tour-info.php?id=<?php //echo $home['id']?>&tour=<?php //echo $lower_tour;  ?>"><?php //echo substr($home['nameof_tour'],0,20); ?></a--><a href="<?php echo $seo_url_tour_info; ?>"><?php echo substr($home['nameof_tour'],0,20); ?></a></h4>
